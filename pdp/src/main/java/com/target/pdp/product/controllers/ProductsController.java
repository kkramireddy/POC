...
/**
 * Products API for retrieving product and price details and update product price information
...
public class ProductsController {
	...
	public ProductsController(ProductServiceInterface productInteface) {
